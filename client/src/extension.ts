...
export function activate(context: ExtensionContext) {
  ...
  const serverOptions: Executable = {
    command: '/home/amelia/default/Projects/agda-lsp/dist-newstyle/build/x86_64-linux/ghc-9.6.3/Agda-2.6.5/build/agda/agda',
    args: ['--lsp'],
  ...
  languages.registerDocumentSemanticTokensProvider(agda, new AgdaTokenProvider(client), legend);
}
